...
const AboutMe = () => {
	return (
		<div>
			...
			<ul>
				<li>Harper Hospital School of Nursing- Registered Nurse Diploma Program- 1976</li>

				<li>St Joseph’s College of Maine- Bachelor of Science in Psychology- 1996</li>

				<li>National Certification Corporation- Certified in Neonatal Intensive Care Nursing-2011</li>
				...
				<li>Energy Healing Certification- Northwestern Community College- July 2020</li>
			</ul>
		</div>
	);
};
