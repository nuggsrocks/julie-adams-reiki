...
const ReikiSession = () => {
  return (
    <div>
      ...
      <p>
        The practitioner will spend some time before the session to explain what
        will happen in the session and share some common reactions to Reiki. The
        practitioner will also discuss what issues brought the person in to
        receive Reiki and answer any questions they may have.
      </p>
      ...
      <p>
        ...
        specific parts of the body for the sharing of energy. The energy sharing
      ...
      <p>
        ...
        It is also not uncommon for someone to not feel much of anything at all.
